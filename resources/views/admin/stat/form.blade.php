    ...
    <form action="{{ route('admin.home.stats.store') }}" method="POST" id="statForm">
        ...
        <div class="card">
            <div class="section-title">
                ...
                <span class="section-sub" style="margin:0;">4 items</span>
            </div>
...
<style>
    ...
    .stats-table-header {
        ...
        color: var(--faint, #9AA1B2);
        padding: 0 4px 10px;
        border-bottom: 1px solid var(--line, #E9EBF2);
        margin-bottom: 14px;
    }
    ...
    .btn-save {
        ...
        font-weight: 600;
        color: #fff;
        background: linear-gradient(135deg, #0F1526, #1D2439);
        border: none;
        padding: 11px 22px;
        border-radius: 9px;
        cursor: pointer;
    ...
    .btn-save:hover {
        ...
        box-shadow: 0 8px 18px -6px rgba(15, 21, 38, 0.5);
    }
