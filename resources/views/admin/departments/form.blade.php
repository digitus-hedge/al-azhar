...
@section('title', $item->exists ? 'Edit Department' : 'Add Department')
@section('content')
...
<div class="wrap">
    <div class="crumbs">
        ...
        <span>&rsaquo;</span>
        <span onclick="window.location='{{ route('admin.departments') }}'">Departments</span>
        <span>&rsaquo;</span>
    ...
    <div class="header">
        <div>
            <h1>{{ $item->exists ? 'Edit Department' : 'Add Department' }}</h1>
            <p>Departments group classes together (e.g. Science, Commerce, Arts).</p>
        </div>
    </div>

    <form action="{{ $item->exists ? route('admin.departments.update', $item) : route('admin.departments.store') }}"
        ...
        <div class="card">
            <div class="section-title">
                <h2><span class="icon"><i class="bi bi-diagram-3"></i></span> Department Details</h2>
            </div>
            ...
            <!-- <div class="field">
                <div class="field-top">
                    ...
                    <span class="field-hint">Optional, e.g. "SCI"</span>
                </div>
                <input type="text" name="code" maxlength="20" style="max-width:200px;"
            ...
            <!-- <div class="field">
                ...
                <textarea name="description" rows="3"
                          ...
                          placeholder="Optional short description...">{{ old('description', $item->description) }}</textarea>
                @error('description')
                    <span class="field-error"><i class="bi bi-exclamation-circle"></i> {{ $message }}</span>
                @enderror
            </div> -->
            ...
            <!-- <label class="toggle-row" for="is_active">
                <span>
                    ...
                    <span class="field-hint d-block">Available for selection when adding classes</span>
                </span>
        ...
        <div class="savebar">
            <div class="savebar-inner">
                ...
                <div class="btn-group">
                    <a href="{{ route('admin.departments') }}" class="btn-cancel">Cancel</a>
                    <button type="submit" class="btn-save">
                        <i class="bi bi-check-lg"></i>
                        {{ $item->exists ? 'Update Department' : 'Create Department' }}
                    </button>
                </div>
            </div>
        </div>
